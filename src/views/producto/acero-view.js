...
class AceroView extends LitElement {
  static styles = css`
    .content {
  ...
  render() {
    return html`
      <div class="content">
        Equipos y tecnología para la prueba de calidad y resistencia de aceros
        utilizados en la construcción. Incluye ensayos de tracción, flexión, y
        análisis de composición química para garantizar el cumplimiento con
...
customElements.define("acero-view", AceroView);

...
class ConcretoView extends LitElement {
  static styles = css`
    .content {
  ...
  render() {
    return html`
      <div class="content">
        Equipos y servicios especializados para el ensayo y verificación de la
        calidad del concreto, incluyendo pruebas de resistencia, durabilidad y
        consistencia, asegurando que cumpla con los estándares nacionales e
        internacionales.
      </div>
...
customElements.define("concreto-view", ConcretoView);

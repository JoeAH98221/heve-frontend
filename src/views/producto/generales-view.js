...
class GeneralesView extends LitElement {
  static styles = css`
    .content {
  ...
  render() {
    return html`
      <div class="content">
        Instrumentos y servicios de laboratorio para pruebas diversas que no
        encajan específicamente en las otras categorías, pero que son esenciales
        para asegurar la calidad en diversos materiales de construcción.
      </div>
...
customElements.define("generales-view", GeneralesView);

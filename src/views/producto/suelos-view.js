...
class SuelosView extends LitElement {
  static styles = css`
    .content {
  ...
  render() {
    return html`
      <div class="content">
        ...
        suelos. Incluye pruebas de compactación, permeabilidad, y resistencia
        para garantizar la calidad y estabilidad en proyectos de construcción.
      </div>
...
customElements.define("suelos-view", SuelosView);
